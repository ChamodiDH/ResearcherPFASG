...
// If valid------------------------
var type = ($("#hiddenResearcherIDsave").val() == "") ? "POST": "PUT";
$.ajax(
		{
		 url : "RsearcherAPI",
		 type : type,
...
{
 $("#hiddenResearcherIDSave").val($(this).closest("tr").find('#hiddenResearcherIDUpdate').val());
 $("#ResearcherID").val($(this).closest("tr").find('td:eq(0)').text());
 $("#Name").val($(this).closest("tr").find('td:eq(1)').text());
 $("#Telno").val($(this).closest("tr").find('td:eq(2)').text());
 $("#Spc").val($(this).closest("tr").find('td:eq(3)').text());
 $("#Uni").val($(this).closest("tr").find('td:eq(4)').text());
